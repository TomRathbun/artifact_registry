...
# Flat REST prefixes (no double nesting like /need/needs or /metadata/metadata)
api_router = APIRouter()
api_router.include_router(users.router, prefix="/users", tags=["users"])
api_router.include_router(linkage.router, prefix="/linkages", tags=["linkages"])
api_router.include_router(need.router, prefix="/needs", tags=["needs"])
api_router.include_router(requirement.router, prefix="/requirements", tags=["requirements"])
api_router.include_router(use_case.router, prefix="/use-cases", tags=["use-cases"])
api_router.include_router(vision.router, prefix="/visions", tags=["visions"])
