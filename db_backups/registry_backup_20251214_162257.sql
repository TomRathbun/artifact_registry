...
Anticipate Emerging Air Threat Using AI	Mission Operator receives proactive AI-generated alert of an emerging threat before it is manually detected on the Recognized Air Picture.	AIC2	Continuous all-source data ingestion and AI processing detects anomalous pattern indicative of emerging threat	322ea09b-7eb0-402a-a745-ec402213439b	[{"step_num": 1, "actor": "AIC2 System", "description": "Continuously ingests and normalizes all-source data", "message": "IngestData(sensors)", "target_actor": null, "response": null}, {"step_num": 2, "actor": "AIC2 System", "description": "Detects anomalous pattern exceeding threat anticipation threshold", "message": "DetectAnomaly()", "target_actor": null, "response": null}, {"step_num": 3, "actor": "AIC2 System", "description": "Generates threat prediction with confidence score and rationale", "message": "GeneratePredictions()", "target_actor": "Mission Operator", "response": null}, {"step_num": 4, "actor": "AIC2 Assistant", "description": "Receives proactive alert on C2 display with predicted track and timeline", "message": "SendsAlert(Threats, COAs)", "target_actor": "Mission Operator", "response": "Acknowledged()"}, {"step_num": 5, "actor": "Mission Operator", "description": "Reviews AI-generated Courses of Action", "message": "ApprovedCOA(COA)", "target_actor": "AIC2 Assistant", "response": null}]	[{"step": "4a", "condition": "Operator requests explanation", "handling": "System displays human-readable rationale and key contributing data sources", "actor": "Mission Operator", "message": "RequestExplanation(COA)", "target_actor": "AIC2 System", "response": "COADetails(COA)"}]	TR2-AIC2-UC-001	DRAFT	2025-12-07 15:22:37.200959	2025-12-14 14:03:14.526232	a1573933-ec35-4bbd-a94c-e0fedbd2581d	[{"trigger": "Model confidence < 70%", "handling": "Flag as low-confidence, route to human analyst for validation", "steps": [{"step_num": 1, "actor": "AIC2 System", "description": "Flag prediction as low-confidence", "message": "FlagPrediction(predictionId, confidence)", "target_actor": "Intel Analyst", "response": "Flagged"}]}]
\.
