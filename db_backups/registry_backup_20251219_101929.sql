...
ALTER TABLE IF EXISTS ONLY public.people DROP CONSTRAINT IF EXISTS uq_person_name_project;
...
COPY public.comments (id, artifact_aid, field_name, comment_text, author, created_at, resolved, resolved_at, resolved_by, selected_text, resolution_action) FROM stdin;
ba2b4cf7-de9f-4e2d-848c-284da987ea84	TR2-AIC2-NEED-002	description	testing comments\n	Reviewer	2025-12-07 11:56:25.415944+04	f	\N	\N	\N	\N
5a4c78c2-69c6-466a-97aa-5fa364a4cc7a	TR2-AIC2-NEED-002	rationale	test 2	Reviewer	2025-12-07 12:01:26.179303+04	t	2025-12-07 08:10:25.300353+04	Reviewer	\N	\N
606aed69-2fce-4973-acd9-f029a943ab4a	TR2-GLOBAL-UC-001	postconditions	seriously	Reviewer	2025-12-07 12:13:27.56472+04	t	2025-12-07 08:13:33.827861+04	Reviewer	\N	\N
4be54bcf-c3fa-422e-ab1f-1b59c6d62836	TR2-AIC2-VISION-001	description	(vendor-agnostic integration) Simplify the English 	Reviewer	2025-12-11 08:36:50.184112+04	t	2025-12-11 05:19:53.703416+04	Reviewer	\N	\N
945e180b-f00e-4f58-b440-683a0f394d43	TR2-AIC2-VISION-001	description	(inspired by Tesla's Full Self-Driving for adaptive, data-driven learning) with physics-based algorithms to optimize performance in critical functions.\n\nJust to reduce uncommon ideas to operators (AFAD)	Reviewer	2025-12-11 08:45:36.034055+04	t	2025-12-11 05:20:44.406056+04	Reviewer	\N	\N
3a7eba7c-0b35-4ee4-944c-3dafc88bce98	TR2-AIC2-VISION-001	description	 (human-issued voice commands) does Lockheed have that in any operation currently US or Australia that maybe can be demonstrated to them ?	Reviewer	2025-12-11 08:48:16.870828+04	t	2025-12-11 05:20:58.33344+04	Reviewer	\N	\N
f5a0171f-6388-4b18-be8e-8581d0ddce20	TR2-AIC2-VISION-001	description	safeguards to maintain human-in-the-loop for high-stakes actions.   or to go fully manual if needed be 	Reviewer	2025-12-11 08:49:14.289386+04	t	2025-12-11 05:22:56.033581+04	Reviewer	\N	\N
43b857c8-6934-40e3-be7f-e5e4f43a6a03	TR2-AIC2-VISION-001	description	This AIC2 vision empowers AFAD operators with AI as a force multiplier, driving efficiency while preserving human judgment, and positions TR2 for future-proof C2 evolution.\n\nto add that it reduces work time or kill chain with orders or actions	Reviewer	2025-12-11 08:53:18.373666+04	t	2025-12-11 05:22:56.809318+04	Reviewer	\N	\N
84c8a806-d2b8-43a5-92b4-e074100fd299	TR2-AIC2-NEED-001	description	rules?	Reviewer	2025-12-12 12:27:04.071519+04	f	\N	\N	rules	\N
53fa4611-e07c-4da0-b1ba-9be6e6b0e878	TR2-AIC2-NEED-001	rationale	TRP2?	Reviewer	2025-12-12 12:36:20.583624+04	f	\N	\N	TRP1	\N
fa6f4286-fcda-4fde-970c-5688b1286f03	TR2-AIC2-NEED-001	rationale	Just added this one	Reviewer	2025-12-12 12:40:03.157645+04	f	\N	\N	integrations	\N
36d132ef-dc9c-47fd-8838-dd5b57b991a6	TR2-AIC2-NEED-001	description	Better how	Reviewer	2025-12-12 12:43:20.929307+04	f	\N	\N	better	\N
339c3055-68f2-4bb8-a917-e955a781bea5	TR2-AIC2-NEED-001	level	Wrong level	Reviewer	2025-12-12 13:00:55.326612+04	f	\N	\N	\N	\N
\.
...
ec9f959b-0b71-4bdd-a7a3-201d410e6ad2	a1573933-ec35-4bbd-a94c-e0fedbd2581d	State Chart		plantuml	null	2025-12-14 14:08:08.144753+04	\N	\N
00082204-0ead-4c2f-8e0f-0654ab89776c	a1573933-ec35-4bbd-a94c-e0fedbd2581d	Test		plantuml	null	2025-12-14 11:48:36.18639+04	2025-12-14 13:06:18.045027+04	@startuml\ntitle Anticipate Emerging Air Threat Using AI - Sequence Diagram for TR2-AIC2-UC-001 MSS\n\nskinparam participant {\n  BackgroundColor LightBlue\n  BorderColor Black\n  FontSize 12\n}\nskinparam noteFontSize 11\nskinparam arrowThickness 1.5\n\nparticipant "AIC2 System" as System\nparticipant "Mission Operator" as Operator\nparticipant "Intelligence Analyst" as Analyst order 30\n\nnote over System, Analyst\nThis sequence diagram details the Main Success Scenario (MSS) interactions from use case TR2-AIC2-UC-001.\nPreconditions assumed met; focuses on actor exchanges for workshop refinement.\nTraceable to need TR2-AIC2-NEED-001 and vision TR2-GLOBAL-VISION-001.\nIn workshops, discuss interfaces (e.g., tying to TR1 CommandIQ in Section 2.2, all-source data from sensors in Section 11).\nend note\n\nloop Continuous Monitoring\n  System -> System : Ingest and normalize all-source data (Step 1)\n  System -> System : Detect anomalous pattern exceeding threshold (Step 2)\n  alt Anomaly Detected\n    System -> System : Generate threat prediction with confidence score and rationale (Step 3)\n    System -> Operator : Send proactive alert with predicted track and timeline (Step 4)\n    alt Extension: Operator requests explanation (4a)\n      Operator -> System : Request rationale\n      System -> Operator : Display human-readable rationale and key data sources\n    end\n    Operator -> Operator : Review AI-generated Courses of Action (Step 5)\n  end\nend\n\nopt Exception: Model confidence < 70%\n  System -> Analyst : Route for validation (low-confidence flag)\n  Analyst -> Analyst : Validate threat\nend\n\nopt Exception: Data feed degradation\n  System -> System : Fall back to legacy sensor fusion\n  System -> Operator : Notify of reduced AI fidelity\nend\n\nnote over Operator\nPostconditions achieved upon MSS completion: Operator alerted, threat track flagged, COAs pre-positioned.\nend note\n\n@enduml
00d0ed1d-8e55-456f-ab28-576ad8854bf5	a1573933-ec35-4bbd-a94c-e0fedbd2581d	Seqence		plantuml	null	2025-12-15 13:17:46.468308+04	\N	\N
a1e070d2-8be5-4f32-b8b5-90aef23dba30	a1573933-ec35-4bbd-a94c-e0fedbd2581d	Process		mermaid	null	2025-12-17 13:44:55.315802+04	2025-12-17 14:44:15.330482+04	flowchart TD\n    A[Vision: Global] -->|refines| B[Vision: Area]\n    B -->|Derive from| C[Needs: Mission, Enterprise, Technical Levels]\n    C -->|Elaborates| D[Use Cases: Trigger, Preconditions, Steps, Post Conditions]\n    D -->|Derive from| E[Requirements: Stakeholder, System, Subsystems]\n    subgraph **Artifact Refinement Process**\n        B\n        C\n        D\n        E\n    end\n    F[Customer Workshops] -.->|Refine & Validate| B\n    F -.->|Refine & Validate| C\n    F -.->|Refine & Validate| D\n    F -.->|Create & Validate| E\n    G[Traceability & Linkages] -.-> A\n    G -.-> B\n    G -.-> C\n    G -.-> D\n    G -.-> E\n\nclassDef external fill:#f9f,stroke:#333,stroke-width:2px\n    class F external
34e247da-fc08-491d-8536-309c51e7d1f4	a1573933-ec35-4bbd-a94c-e0fedbd2581d	AR Architecture		mermaid	null	2025-12-17 15:17:04.428053+04	2025-12-17 15:21:21.820215+04	flowchart TD\n    A[User] -->|HTTP| B["React Client: Port 5173"]\n    C[User] --> |HTTP| B\n    B -->|JSON / REST| FastAPI["FastAPI Backend: Port 8000"]\n    FastAPI -.->|Generates| Docs["API Docs: /docs"]\n    FastAPI -->|SQL| PG["PostgreSQL: Port 5432"]
d2ebfaa0-24ef-4262-9b1f-6a060df6b5f5	a1573933-ec35-4bbd-a94c-e0fedbd2581d	Example		artifact_graph	{"area": "AIC2", "selection": ["TR2-AIC2-NEED-007", "TR2-AIC2-UC-008", "TR2-DSO-DOC-001", "TR2-AIC2-VISION-001", "TR2-GLOBAL-VISION-001", "TR2-CLD-DOC-001"], "positions": {"TR2-GLOBAL-VISION-001": {"x": 861.3152173913043, "y": -117.67880434782612}, "TR2-AIC2-VISION-001": {"x": 493.8657608695653, "y": -119.01440217391308}, "TR2-AIC2-NEED-007": {"x": 147.77065217391294, "y": 59.011956521739194}, "TR2-AIC2-UC-008": {"x": 145.6855978260869, "y": -118.00244565217402}, "TR2-DSO-DOC-001": {"x": 679.0736506498736, "y": 222.27675444271904}, "TR2-CLD-DOC-001": {"x": 352.268966384863, "y": 220.53813441741426}}}	2025-12-17 14:20:03.179675+04	2025-12-18 20:04:18.08311+04	\N
\.
...
Comms SDP	Comms SDP	FILE	/api/v1/documents/files/20251215064500_SDP Comms.pdf	application/pdf	TR2-GLOBAL-DOC-003	DRAFT	GLOBAL	2025-12-15 06:45:03.108887	2025-12-15 06:50:33.493044	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
PlantUML Syntax guide		TEXT		\N	TR2-GLOBAL-DOC-004	DRAFT	GLOBAL	2025-12-15 13:16:16.137235	2025-12-15 13:50:05.892673	a1573933-ec35-4bbd-a94c-e0fedbd2581d	# PlantUML Syntax Guide for Systems Engineering and MBSE\n PlantUML allows us to generate UML diagrams (e.g., class, sequence, activity, component diagrams) using simple text-based syntax, which can be rendered into images for workshops or artifact registries.\nPlantUML diagrams start with @startuml and end with @enduml. To render in a markdown document, add a plamtUML code block using ```platntuml\n````\n```plantuml\n@startuml\nAlice -> Bob: Authentication Request\nBob --> Alice: Authentication Response\n\nAlice -> Bob: Another authentication Request\nAlice <-- Bob: another authentication Response\n@enduml\n```\n````\n\n1. ** Basic Structure and Skin Parameters**\n\nStart/End: Every diagram begins with @startuml and ends with @enduml.\nTitle and Notes: Add title My Diagram for a title. Use note left/right/top/bottom: My note for annotations.\nSkin Parameters: Customize appearance with skinparam (e.g., skinparam backgroundColor #EEE for light background, or skinparam monochrome true for black-and-white).\n\n### Example (Basic Setup):\n````\n```plantuml\n@startuml\ntitle EADGE-T TR2 High-Level Architecture\nskinparam monochrome true\nnote top: Visualizing Phase 2 needs based on Phase 1 refresh\n@enduml\n@enduml\n```\n````\n\n```plantuml\n@startuml\ntitle EADGE-T TR2 High-Level Architecture\nskinparam monochrome true\nnote top: Visualizing Phase 2 needs based on Phase 1 refresh\n@enduml\n@enduml\n```\n\n2. **Component Diagrams (For System Architectures)**\n\nUseful for modeling subsystems like compute infrastructure, networks, or cybersecurity components in EADGE-T TR2.\nComponents: [Component Name] for boxes.\nInterfaces: () Interface Name for ports.\nConnections: -- for lines, -->, <-- for arrows. Add labels with  : label.\nPackages/Groups: package "Group Name" { ... } to group elements.\nStereotypes: <<stereotype>> for types (e.g., <<Subsystem>>).\n\n### Example (Modeling EADGE-T Infrastructure from Phase 1 Proposal):\n\n````\n```plantuml\n@startuml\ntitle EADGE-T TR2 Compute and Network Infrastructure\npackage "SECL Domain" {\n    [AOC] <<Site>>\n    [AAOC] <<Site>>\n    [SDC] <<Site>>\n}\npackage "Cybersecurity Layer" {\n    [SIEM] <<Tool>>\n    [Antivirus] <<Tool>>\n    [Vulnerability Scanner] <<Tool>>\n}\n[AOC] --> [SIEM] : Monitors events\n[AAOC] --> [Antivirus] : Protects endpoints\nnote bottom of [SIEM]: Aligns with NIST 800-53 for continuous monitoring (from Phase 1 POA&M)\n@enduml\n```\n````\n\n```plantuml\n@startuml\ntitle EADGE-T TR2 Compute and Network Infrastructure\npackage "SECL Domain" {\n    [AOC] <<Site>>\n    [AAOC] <<Site>>\n    [SDC] <<Site>>\n}\npackage "Cybersecurity Layer" {\n    [SIEM] <<Tool>>\n    [Antivirus] <<Tool>>\n    [Vulnerability Scanner] <<Tool>>\n}\n[AOC] --> [SIEM] : Monitors events\n[AAOC] --> [Antivirus] : Protects endpoints\nnote bottom of [SIEM]: Aligns with NIST 800-53 for continuous monitoring (from Phase 1 POA&M)\n@enduml\n```\n\nThis would render a diagram showing sites connected to cybersecurity tools, useful for defining TR2 needs like "Mission-level need for enhanced monitoring."\n\n3. **Use Case Diagrams (For Stakeholder Needs and Use Cases)**\n\nIdeal for capturing needs statements at Mission, Enterprise, or Technical levels, as per our process.\nActors: actor ActorName or actor :Actor Name: as Alias.\nUse Cases: usecase (Use Case Name) as UC1.\nAssociations: ActorName --> (Use Case Name) : extends/includes.\nBoundaries: boundary "System Boundary" { ... }.\n\n### Example (TR2 Use Case for AI-Driven Capabilities, Inspired by Phase 1 AI/ML Readiness):\n\n````\n```plantuml\n@startuml\ntitle TR2 Use Case: AI Threat Anticipation\nactor "Mission Operator" as MO\nactor "Air Power Commander" as APC\nusecase (Anticipate Threats) as AT\nusecase (Analyze Data) as AD\nrectangle "EADGE-T System" {\n    MO --> AT : Real-time analysis\n    AT ..> AD : includes\n}\nnote right of AT: *As* Mission Operators, *We need* AI tools to anticipate threats, *So that* we act before adversaries (Mission Level Need)\nAPC --> AT : Oversees\n@enduml\n```\n````\n\n```plantuml\n@startuml\ntitle TR2 Use Case: AI Threat Anticipation\nactor "Mission Operator" as MO\nactor "Air Power Commander" as APC\nusecase (Anticipate Threats) as AT\nusecase (Analyze Data) as AD\nrectangle "EADGE-T System" {\n  MO --> AT : Real-time analysis\n  AT ..> AD : includes\n}\nnote right of AT: *As* Mission Operators, *We need* AI tools to anticipate threats, *So that* we act before adversaries (Mission Level Need)\nAPC --> AT : Oversees\n@enduml\n```\n\nThis visualizes a needs statement in JSON format, e.g., for artifact "TR2-AIC2-NEED-001".\n\n4. **Sequence Diagrams (For Interactions and Workflows)**\n\nGreat for modeling deployment sequences or integration tests from Phase 1 to inform TR2 workshops.\nParticipants: participant Name as Alias.\nMessages: A -> B : Message.\nActivations: activate A / deactivate A.\nLoops/Alternatives: loop Condition ... end, alt Condition ... else ... end.\n\n### Example (Deployment Sequence from Phase 1 Proposal):\n\n````\n```plantuml\n@startuml\ntitle TR2 Deployment Workflow (Extending Phase 1 Approach)\nparticipant "US Lab" as USL\nparticipant "SDC Pre-Ops" as SDC\nparticipant "AOC" as AOC\nUSL -> SDC : Integrate TR2 changes\nactivate SDC\nSDC -> SDC : System Checkout & Testing\nSDC -> AOC : Deploy to Live Site\ndeactivate SDC\nalt Success\n    AOC --> AOC : Operational Testing\nelse Failure\n    AOC -> USL : Report Issues\nend\nnote left: Progressive deployment minimizes downtime (from Phase 1 Figure 2.0-1)\n@enduml\n```\n````\n\n```plantuml\n@startuml\ntitle TR2 Deployment Workflow (Extending Phase 1 Approach)\nparticipant "US Lab" as USL\nparticipant "SDC Pre-Ops" as SDC\nparticipant "AOC" as AOC\nUSL -> SDC : Integrate TR2 changes\nactivate SDC\nSDC -> SDC : System Checkout & Testing\nSDC -> AOC : Deploy to Live Site\ndeactivate SDC\nalt Success\n    AOC --> AOC : Operational Testing\nelse Failure\n    AOC -> USL : Report Issues\nend\nnote left: Progressive deployment minimizes downtime (from Phase 1 Figure 2.0-1)\n@enduml\n```\n\n5. **Activity Diagrams (For Processes and Flows)**\n\nUseful for outlining our process: vision → needs → use cases → workshops.\nStart/End: start / stop.\nActions: :Action;.\nDecisions: if (Condition) then (yes) ... else (no) ... endif.\nForks: fork ... fork again ... end fork.\n\n### Example (TR2 Requirements Refinement Process):\n\n````\n```plantuml\n@startuml\ntitle TR2 Requirements Process\nstart\n:Create Vision Statement;\n:Define Needs (Mission/Enterprise/Technical);\nfork\n    :Develop Use Cases;\nfork again\n    :Import to Artifact Registry (JSON Format);\nend fork\nif (Workshop Needed?) then (yes)\n    :Conduct Customer Workshop;\n    :Refine Requirements;\nelse (no)\n    :Finalize Artifacts;\nendif\nstop\n@enduml\n```\n````\n\n```plantuml\n@startuml\ntitle TR2 Requirements Process\nstart\n:Create Vision Statement;\n:Define Needs (Mission/Enterprise/Technical);\nfork\n:Develop Use Cases;\nfork again\n:Import to Artifact Registry (JSON Format);\nend fork\nif (Workshop Needed?) then (yes)\n:Conduct Customer Workshop;\n:Refine Requirements;\nelse (no)\n:Finalize Artifacts;\nendif\nnote left: Links to Phase 1 updates like POA&M remediation\nstop\n@enduml\n```\n\n6. **Class Diagrams (For Data Models and Linkages)**\n\nFor modeling artifacts and linkages in the Artifact Registry (e.g., needs JSON structure).\nClasses: class ClassName { +attribute: type }.\nRelationships: ClassA -- ClassB : association, ClassA <|-- ClassB : inheritance.\nMultiplicity: 1..*, *.\n\n### Example (Modeling Needs Artifact JSON):\n\n````\n```plantuml\n@startuml\ntitle TR2 Artifact Model\nclass Artifact {\n    +aid: String\n    +title: String\n    +description: String\n    +level: Enum (Mission, Enterprise, Technical)\n}\nclass Linkage {\n    +from: String\n    +to: String\n}\nArtifact "1" -- "*" Linkage : has\nnote on link: Linkages array in JSON, e.g., ["TR2-AIC2-NEED-001", "TR2-GLOBAL-VISION-001"]\n@enduml\n```\n````\n\n```plantuml\n@startuml\ntitle TR2 Artifact Model\nclass Artifact {\n    +aid: String\n    +title: String\n    +description: String\n    +level: Enum (Mission, Enterprise, Technical)\n}\nclass Linkage {\n    +from: String\n    +to: String\n}\nArtifact "1" -- "*" Linkage : has\nnote on link: Linkages array in JSON, e.g., ["TR2-AIC2-NEED-001", "TR2-GLOBAL-VISION-001"]\n@enduml\n```\n\nTips for MBSE Integration in TR2\n\nRelevance to EADGE-T: Use these diagrams to visualize Phase 1 elements (e.g., from Table 2.1-1) and extend them to TR2 needs, like AI/ML integration or JERNAS trade studies.\nRendering: Paste syntax into plantuml.com/plantuml for quick images. In code environments, use Python: import plantuml; p = plantuml.PlantUML(); p.processes('syntax here').\nBest Practices: Keep diagrams simple (under 20 elements). Use notes to reference PDF sections or needs levels. For workshops, export as PNG/SVG.\nAdvanced Features: Include colors (skinparam componentBackgroundColor #LightBlue), or deploy in tools like SysML for full MBSE.
Tech Refresh Phase 2 Report		TEXT		\N	TR2-GLOBAL-DOC-005	DRAFT	GLOBAL	2025-12-17 13:43:48.319968	2025-12-19 08:55:52.027725	a1573933-ec35-4bbd-a94c-e0fedbd2581d	# TR2 Progress Report\n\n## Executive Summary\n\nThe TR2 effort aims to extend EADGE-T's capabilities beyond TR1's foundational enhancements, focusing on advanced features like:\n\n1.  **AI-Augmented Command and Control**: AI-driven detection, planning, and enhanced ISR processing to anticipate and neutralize threats in real-time, utilizing force-level TEWA (Threat Evaluation and Weapon Assignment) and Combat Cloud principles to enable 'any sensor, any shooter' flexibility—decoupling sensors from effectors for dynamic, multi-domain data sharing and resource allocation across networked forces.\n2.  **Remote Sites Modernization**: Uplift of core routing and remote site's Networking Stack to support site to site routing, add a virtualized compute stack, ensure power resilience, and preplanned integrations for emerging transports (e.g., 5G for low-latency terrestrial links and Leo satellite constellations for backups)\n3. **Remote Access and Mobile Enclaves**: Zero-trust remote access, rapid mobile enclave deployment, with automated management, power resilience, and anti-tampering.\n4. **Extensible Communications**: GATR radio data/voice integration with JERNAS, RF Link 16 Radio Voice/Data integration for Red and Pink Domains, and unified VoIP/RoIP Architecture\n5. **DevSecOps and MLOps**: DoD-aligned software factories incorporating automated pipelines for regression testing, security compliance testing,  AI/ML algorithms back testing for streamline development and deployment without compromising compliance\n\nHowever, due to ongoing TR1 contracting challenges (e.g., unresolved core and non-core options, pricing concerns), the TR2 starting point remains undefined. This report emphasizes the process for scope definition and requirements elicitation, rather than preliminary content, which has not been vetted internally or with AFAD/Operators.\n\nThe MBSE-driven process starts with global **Vision** statement with a refined **Visions** for each area. **Needs** are derived from the area **Visions** at three levels: Mission, Enterprise, and Technical. **Need** descriptions follow a specific grammar: \n\n````\nAs <stakeholder>, we need <the need>, so that <the benefit>. \n````\n\n**Use Cases** are derived from the **Needs** with the purpose of illustrating what the needs entails at a scenario level. Given a validated **Use Case**, then Stakeholder level **Requirements** can be created. Since requirements are often unclear, they are written with a specific grammar following the Easy Approach to Requirements Syntax (EARS), which is a set of grammars developed by Rolls Royce, now widely adopted.\n\n````\n**Unconditional**: The system shall <always true behavior>\n**Event-Driven**: When <event>, the system shall <response>\n**State-Driven**: While in <state>, the system shall <true behavior>\n**Unwanted Behavior**: If <behavior>, then the system shall <response>\n**Optional Features**: "Where <condition>, the system shall <behavior>\n````\n\nThe main purpose of the customer workshops is to validate the artifacts (**Vision**, **Needs**, **Use Cases**) and then create the **Requirements**, see **Figure 1**\n\n```mermaid\nflowchart TD\n    A[Vision: Global] -->|refines| B[Vision: Area]\n    B -->|Derive from| C[Needs: Mission, Enterprise, Technical Levels]\n    C -->|Elaborates| D[Use Cases: Trigger, Preconditions, Steps, Post Conditions]\n    D -->|Derive from| E[Requirements: Stakeholder, System, Subsystems]\n    subgraph **Artifact Refinement Process**\n        B\n        C\n        D\n        E\n    end\n    F[Customer Workshops] -.->|Refine & Validate| B\n    F -.->|Refine & Validate| C\n    F -.->|Refine & Validate| D\n    F -.->|Create & Validate| E\n    G[Traceability & Linkages] -.-> A\n    G -.-> B\n    G -.-> C\n    G -.-> D\n    G -.-> E\n\nclassDef external fill:#f9f,stroke:#333,stroke-width:2px\n    class F external\n```\n**Figure 1: Process Flow for TR2 Requirements Elicitation**\n\n## Artifact Registry Motivation\n\nThe Artifact Registry was developed to overcome the inefficiencies of spreadsheet-based artifact management, which struggles with relational data, visual integration, and traceability in large-scale systems engineering efforts like TR2. By leveraging a structured PostgreSQL database, FastAPI backend, and Node.js frontend (See **Figure 2**), it provides a vertical, intuitive interface for displaying related information, seamless linking between artifacts, embedded graphics (e.g., Mermaid diagrams for use cases), and hyperlinks to external resources (e.g., the EADGE-T TR1 Proposal PDF). This not only streamlines requirements elicitation and collaboration but acts as a force multiplier, ensuring traceability and consistency across the engineering lifecycle—critical when TR1 baseline uncertainties (e.g., unresolved core/non-core options from the Lockheed Martin proposal dated 15 November 2025) delay customer engagements for TR2 scope definition, see **Figure 3**\n\n```mermaid\nflowchart TD\n    A[User] -->|HTTP| B["React Client: Port 5173"]\n    C[User] --> |HTTP| B\n    B -->|JSON / REST| FastAPI["FastAPI Backend: Port 8000"]\n    FastAPI -.->|Generates| Docs["API Docs: /docs"]\n    FastAPI -->|SQL| PG["PostgreSQL: Port 5432"]\n```\n**Figure 2: Artifact Registry Architecture**\n\n\n![Artifact-Registry.png](/uploads/Artifact-Registry.png)\n\n**Figure 3: Artifact Registry Screenshot**\n\n### Artifact Linkages\n\nThe linkage approach in the Artifact Registry embodies Model-Based Systems Engineering (MBSE) best practices, ensuring end-to-end traceability and consistency across the Tech Refresh Phase 2 (TR2) effort by interconnecting core artifacts such as vision, needs, associated use cases and requirements. Beyond core artifacts, this extensible framework supports linkages to diagrams (e.g., Mermaid-rendered process flows or sequence diagrams for use cases), documents, and external URLs, empowering efficient scope definition, risk mitigation, and collaborative requirements evolution for EADGE-T modernization. Figure 4 shows the graph of the linkages between the Global Vision, AIC2 Vision, a Need and Use Case. It also shows the linkage between the AIC2 Vision and the Combat Cloud and DevSecOps documents. Linkages manifest themselves as hyperlinks enabling quick navigation between linked artifacts\n\n![Example](/api/v1/documents/files/20251218200416_graph-Example-1766073856306.png)\n**Figure 4: Artifact Linkage**\n\n\nOnce TR1 baseline is confirmed, we can engage stakeholders to refine TR2 artifacts. A key attribute of the artifacts is it's Area. The areas are meant to focus on specific aspects of the EADGE-T System being refreshed and provide a convenient method to filter the artifacts. The areas maps to the pillars in the vision statement, see below:\n\nThe following table maps Areas to the original phase 2 topics.\n\n| Area | Topic | Sub Topic | \n| :--- | :--- |  :--- |\n| AI Command & Control | Combat Cloud |  |\n| | Load Balancing / Failover Enhancements Deployment | |\n| | Tactical C2 Replacement and Modernization | \n| | ISR Processing Enhancements | ISR |\n| | Force Level TEWA | |\n| | AI/ML – Sensor & Weapon Blue Force Laydown | |\n| | AI/ML Video Exploitation | |\n| | AI/ML - Automated Tanker Refueling | |\n| | Study - LRDR Integration | |\n| Remote Site Modernization | Remote Sites Tech Refresh | |\n| Remote Access and Mobile Enclaves| Encrypted Laptop Comm | |\n| | Portable, Adaptable, Mobile Comms Kits | |\n| Extensible Communications | Link-16 RF Integration | |\n| | Quintron Voice Equipment for New Radios | |\n| | New GATR/SHORAD Radios Integration | JERNAS |\n| | Red/Pink Enclaves CDS Integration | |\n| DevSecOps and MLOps | SDC Additional Test String | |\n| | SW Factory and DevSec Pipeline | |\n| | Full DevSecOps (SDC -> Ops) | |\n---\n\nMore subtopics are likely to be created as the process matures\n\n### Current Progress and Example Artifacts\n\nProgress to date focuses on demonstrating the process through initial drafts. Artifacts are stored in the Artifact Registry which supports multiple import export facilities. There is a JSON format for import and export of Artifacts that contain the low-level details of the artifact. Markdown and word formats are also supported for exporting the artifacts presentation view.\n\n| Artifact | Area | Count |\n|:--|:--|:--|\n| Vision | Global | 1 |\n|  | AI Command & Control | 1 |\n| | Remote Site Modernization | 1 |\n| Need |  AI Command & Control | 8 |\n| | ISR | 5 | \n| | JERNAS | 7 | \n| |  Remote Site Modernization| 3 |\n| | Unified Communications | 5 |\n| Use Case | AI Command & Control | 9 |\n\n---\n## Example Artifacts: AIC2 Area (AI Command & Control)\n\nThis area extends TR1's foundational AI/ML options, focusing on threat anticipation.\n\n### TR2-AIC2-VISION-001: "AI-Augmented Command and Control (AIC2) Vision for Tech Refresh Phase 2: \nThe AIC2 vision for Tech Refresh Phase 2 (TR2) extends Phase 1's foundational enhancements—such as CommandIQ integrations—to embed AI/ML for real-time decision support, predictive threat analysis, and automated courses of action."\n#### Key Principles of AIC2\n1. **Hybrid Algorithmic Approaches**: \n2. **Levels of Autonomy: Manual to Automated Execution**: .\n3. **Open Standards for AI Integration and Evolution**: \n---\n\n## TR2-AIC2-NEED-001: Smarter Threat Tracking and Prediction\n\n*derives_from*: TR2-AIC2-VISION-001\n\n**Area**: AIC2 | **Level**: Mission\n**Owner**: Air Defence Technical Directorate | **Stakeholder**: Mission Operator\n\n### Description\n\n*As* **UAE AFAD Mission Operators**, \n\n- *We need* AI tools that combine smart learning with proven rules to better tracking, ID, threat predictions, and engagement calculations\n- *So that* we can handle dense threat environments and asymmetric threats\n\n### Rationale\n\nSimplifies complex tracking for operators, extending TRP1's sensor integrations (Section 11.0).\n\n### Related Sites\n\n* **AAOC** `SECL` 🏷️ Pink\n* **AOC** `SECL` 🏷️ Pink\n\n### Related Components\n\n* **CIQ Exportable Tracker** `Software` `Planned` 🏷️ TR2\n* **CIQ Threat Assessment** `Software` `Planned` 🏷️ TR2\n* **CIQ Engagement** `Software` `Planned` 🏷️ TR2\n* **CIQ Effector Management** `Software` `Planned` 🏷️ TR2\n\n---\n\n## TR2-AIC2-UC-001: Anticipate Emerging Air Threat Using AI\n\n**Area**: AIC2\n\n**Description**: Mission Operator receives proactive AI-generated alert of an emerging threat before it is manually detected on the Recognized Air Picture.\n\n**Primary Actor**: Mission Operator\n\n**Trigger**: Continuous all-source data ingestion and AI processing detects anomalous pattern indicative of emerging threat\n\n### Preconditions\n- System is operational\n- Real-time data ingestion backbone active\n- AIC2 threat anticipation models deployed and running\n\n### Main Flow\n1. **AIC2 System**: Continuously ingests and normalizes all-source data\n2. **AIC2 System**: Detects anomalous pattern exceeding threat anticipation threshold\n3. **AIC2 System**: Generates threat prediction with confidence score and rationale\n4. **AIC2 System**: Receives proactive alert on C2 display with predicted track and timeline\n5. **Mission Operator**: Reviews AI-generated Courses of Action\n\n### Postconditions\n- Operator is alerted with high-confidence threat prediction\n- Threat track automatically created/flagged\n- Recommended COAs pre-positioned for review\n\n### Diagrams\n\n#### Hybrid State Diagram\n\n![State Diagram](https://www.plantuml.com/plantuml/png/TLNHRXit47o_hrYWA20NESTMN1GGYY2ox2G6ggQ8x2SxCAZZwaI8Hrv9dcKboBztbkUpBQTvq8Euo-NipEpUkvXKI5rZYsIIPPgwP2hJgiHqtd2eZQjfQW9ThWEhH5Sn7rnGIHztos0qBPBadXbL1zNGoYFryxYSNip6vTMiF3ewBeguCQvL4dO-yNllqi9yPJeUFul4NEPRGVGKFy6_KrLjwk0xfsVUelXVfbwdKzknn7pG7FhpKul4ulkpYYe4lxrScshZE4OQ5yNrRr-er7xhohVqJ-3AEssIyIxUpZdHX1QxcBYX2uTJPSrN9K70pz3-xyBUsUJ6bKC94yct7781PINmcPKjascOj4gAm297YT8Ik9VUCQagcJkMN26FKa-u6lIGtCPhjf4qjzRlM2EeANJEeLfH_0Xmw7MkZBkzYdmxKv41-_eocBhcCA4Pk3QkyrqaPMqPVHUg7n3AAr2y3Ru2aQA_viHLmXtd6sNbDW0c3WwtjAcKD49-HJmug6_coy3bFg1VigOV0hC3E8dHeglaBLfKx5GmdaRpnU80ffiB0wGGuNyxTjMJyt1hwyCchdqhKXmVzZJsWamWghHpXiv6aLtq8HxSkF6BfBFSrpHtjHiXuSsBX0_iH5K6r-WpCorf9o_I5knqd5eEQTJFJNn5iqzJUVBtGveRi0XUFsM7UCWmRK7k7MlaZF13seqxlq_0-M2i4tL8rqC-1UazWd--RwrosHjmzjl1VTf4dEyYhRj6kH80j5fYjWS_SfPqmpk2OL8moovbLKNstWAnA6HKAOWoekIUOiNvVSLjxfv6ow1SjHRwuuCa1taIhdkfyCBAwApKd_J7qQyPvtkhQX7H-ctvbF2ACETuDFaUE512XfZoKhd3GEf-845kNYH5iU-Znz7sCJsRX6crDWnonVXm4JpVj1P2qslwszEL2nozbVXJLuz6_Ncf_KZk-54V8zC4yP6uDMbDQx3uhCzXjDj74ydjXmMR0lO1gIx1WvXyJ2LKaWZhrolGLhFkrqdbcmPCu0rnbXGhMnyp79ojiatk36-n67xInC2NhCK9DZjJfl7SwQ9uXzBuAFm7)\n\n#### Sequence Diagram\n\n![Sequence Diagram](https://www.plantuml.com/plantuml/png/ZPBRIWCn48Rlzoa6GLYX1V5645SQUf2zM2hM5mYRSGtD9Z4pjUtRcxJIWxjYRq98vfkP_vyP4Sl0gzPajDJMoo1R8DuQZ6VGzUyV_5oXhR528jcWCBgnKADb39bnpaCbjOMPSUliIfJZErXiYR6zWk4Jd3qyG6aR99v8bZcX9HVe1lw59iXOix2kbMQRNm0yeyKW6Ly2ggX6EqlzMAM9uY_CVOft8R8Bj8g4mS3vsqT0oJI0yLpi-ko4mx1RNDHBwzO6LOCgLPM63m24P2Kn0MwyaLQctleJT_A-xj7f4SnZNrrPV-YAiT57gGtzO57dPOM5zy5zeOhO2LeKCDtKw7VkGb5apZDKJg61sjbthTB6m2FStrxtEL_6xJ4WR9meSImoCx8vZYltXskf1YS9aznpj6y4ALbqVz_eA1vfdxy1)\n\n---\n\n\nThis AIC2 thread illustrates how visions trace to needs and use cases, with linkages ensuring consistency.\n\nIf the above example was validated, then the following are example Stakeholder Requirements created for this Thread\n\n### Requirements List (EARS Format)\n\n- **TR2-AIC2-REQ-001** (State-Driven):\nWhile the system is operational, the AIC2 subsystem shall continuously ingest and normalize all-source data from the real-time ingestion backbone.\n- **TR2-AIC2-REQ-002** (Event-Driven):\nWhen an anomalous pattern exceeds the threat anticipation threshold, the AIC2 subsystem shall detect the pattern and generate a threat prediction with an associated confidence score and rationale.\n- **TR2-AIC2-REQ-003** (Event-Driven):\nWhen a threat prediction is generated, the AIC2 subsystem shall receive a proactive alert on the C2 display, including the predicted track and timeline.\n- **TR2-AIC2-REQ-004** (Unwanted Behavior):\nIf the confidence score of a threat prediction is below the high-confidence threshold, then the AIC2 subsystem shall flag the prediction for manual review without automatic track creation.\n- **TR2-AIC2-REQ-005** (State-Driven):\nWhile AIC2 threat anticipation models are deployed and running, the AIC2 subsystem shall pre-position recommended Courses of Action (COAs) for operator review upon alert generation.\n- **TR2-AIC2-REQ-006** (Optional Feature):\nWhere all-source data includes emerging sensor inputs from TR1 integrations, the AIC2 subsystem shall prioritize real-time analysis to anticipate threats before manual detection on the Recognized Air Picture.\n- **TR2-AIC2-REQ-007** (Complex - Event-Driven with Condition):\nWhen continuous data ingestion detects an anomalous pattern indicative of an emerging threat, if the system is in a high-threat environment state, then the AIC2 subsystem shall automatically create and flag a threat track with high-confidence predictions.\n\nThen design teams would create System and Subsystem requirements with linkages to these Stakeholder requirements\n\n## Next Steps and Risks\n\nOnce the TR1 contracting uncertainties are resolved, the TR2 effort can advance from draft artifacts to stakeholder-validated requirements. The following outlines prioritized actions, leveraging the Artifact Registry's for artifact management for collaborative reviews:\n\n1. **Continue Artifact creation (Immediate, Ongoing)**: Continue to update the artifacts filling out the missing areas. Refine the areas and add areas as needed. Updated TR2 visions accordingly as new areas evolve.\n\n2. **Internal Vetting of Draft Artifacts (January, 2026)**: Conduct Lockheed-internal reviews of current drafts to refine content before customer exposure. Use the Artifact Registry's vertical display and linkage graphs to identify inconsistencies, such as ensuring all Mission-level needs (e.g., TR2-AIC2-NEED-001) derive Enterprise and Technical counterparts.\n\n3. **Schedule Customer Workshops (February 2026)**: Upon TR1 confirmation, organize 2-3 workshops with UAE AFAD/Operators to validate visions, needs (at Mission, Enterprise, and Technical levels), and use cases. Focus on deriving stakeholder requirements using EARS grammar, with the Artifact Registry facilitating real-time updates and hyperlinks to TR1 Proposal sections (e.g., cybersecurity alignments in Section 3.0). Target completion by mid-February, however any delay will push this pass Ramadan.\n\n4. **Enhance Artifact Registry Capabilities (Parallel Effort)**: Iterate on the tool to add features like automated EARS validation in requirements creation and expanded export formats (e.g., Word for formal submissions), ensuring seamless integration of diagrams (e.g., Mermaid for use case sequences) and external documents like the TR1 Proposal PDF.\n\n5. **Risk Mitigation**: Key risks include prolonged TR1 delays impacting TR2 timelines—mitigate by preparing contingency visions assuming minimal core options. Address potential scope creep in workshops by prioritizing areas like AI-Augmented Command and Control, tied to TR1's foundational enhancements.\n\nThese steps ensure a structured progression toward high-level stakeholder system and subsystem requirements, with all artifacts traceable in the Artifact Registry for efficient MBSE execution.\n\n\n\n\n\n
\.
...
COPY public.exceptions (id, trigger, handling, project_id, steps) FROM stdin;
59e72748-7d73-4261-a57e-e74a0e34d92a	faulure	call admin	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
4aef7fdc-b4f0-40f7-9c98-51104ba3d9fc	Model confidence < 70%	Flag as low-confidence, route to human analyst for validation	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
03a4ee81-cccd-4bf3-ac7c-da99f8ebaa02	Data feed degradation	Fall back to legacy sensor fusion, notify operator of reduced AI fidelity	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
231e3778-1950-46b9-8533-27262f58cc70	Insufficient resources to meet all tasks	AI prioritizes tasks per commander guidance and highlights shortfalls	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
f3ef7870-5aa4-4d99-b4a4-14024f87e7d9	Assistant confidence low or knowledge gap	Escalates to human SME and logs for training improvement	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
bd35e2b3-4744-42c0-9ceb-55d45873f24d	Governance check fails	Pipeline halts deployment, notifies team with specific failure reason	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
529af3bb-2283-4958-b10b-4007ba13ad6c	AI confidence < 70%	Route to human analyst for confirmation	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
28bf7023-789f-4790-9e77-9b76d6008e06	System fault during engagement	Fail-safe to manual procedures	a1573933-ec35-4bbd-a94c-e0fedbd2581d	\N
\.
...
23175d6a-4c79-4cfe-9f49-f33a8c4eaa31	need	TR2-AIC2-NEED-004	need	TR2-AIC2-NEED-003	REFINES	a1573933-ec35-4bbd-a94c-e0fedbd2581d
6a51109f-224a-453a-8b96-14ba26ac0e15	need	TR2-AIC2-NEED-009	need	TR2-AIC2-NEED-004	RELATED_TO	a1573933-ec35-4bbd-a94c-e0fedbd2581d
7017370c-c82f-4909-b544-7dbeaaaef296	use_case	TR2-AIC2-UC-001	need	TR2-AIC2-NEED-001	DERIVES_FROM	a1573933-ec35-4bbd-a94c-e0fedbd2581d
28ba0de3-a887-4a81-932d-18ecbb891f1c	use_case	TR2-AIC2-UC-008	need	TR2-AIC2-NEED-007	TRACES_TO	a1573933-ec35-4bbd-a94c-e0fedbd2581d
\.
...
TR2-AIC2-NEED-009	481c82b7-8b32-4616-ba13-e2e2517c0edc
TR2-AIC2-NEED-009	5404944f-6bc4-4ce6-91bd-3f1e583154d8
TR2-AIC2-NEED-009	41540101-94bd-4b13-9b2d-7abfa3bd3be4
TR2-AIC2-NEED-009	4e79498c-c8d5-4cfd-8baf-5bc2b7cda29c
\.
...
TR2-AIC2-NEED-001	dc0297e1-6751-4ba8-8af9-d8f77235b753
\.
...
a3d52b10-4e41-405e-97cc-5fe9d5631b58	Intel Analyst	\N	a1573933-ec35-4bbd-a94c-e0fedbd2581d	["actor"]
\.
...
COPY public.use_cases (title, description, area, trigger, primary_actor_id, mss, extensions, aid, status, created_date, last_updated, project_id, exceptions) FROM stdin;
...
Anticipate Emerging Air Threat Using AI	Mission Operator receives proactive AI-generated alert of an emerging threat before it is manually detected on the Recognized Air Picture.	AIC2	Continuous all-source data ingestion and AI processing detects anomalous pattern indicative of emerging threat	322ea09b-7eb0-402a-a745-ec402213439b	[{"step_num": 1, "actor": "AIC2 System", "description": "Continuously ingests and normalizes all-source data", "message": "IngestData(sensors)", "target_actor": "", "response": null}, {"step_num": 2, "actor": "AIC2 System", "description": "Detects anomalous pattern exceeding threat anticipation threshold", "message": "DetectAnomaly()", "target_actor": "", "response": null}, {"step_num": 3, "actor": "AIC2 System", "description": "Generates threat prediction with confidence score and rationale", "message": "GeneratePredictions()", "target_actor": "", "response": null}, {"step_num": 4, "actor": "AIC2 System", "description": "Receives proactive alert on C2 display with predicted track and timeline", "message": "SendsAlert(Threats, COAs)", "target_actor": "Mission Operator", "response": "Acknowledged()"}, {"step_num": 5, "actor": "Mission Operator", "description": "Reviews AI-generated Courses of Action", "message": "ApprovedCOA(COA)", "target_actor": "AIC2 System", "response": null}]	[{"step": "4a", "condition": "Operator requests explanation", "handling": "System displays human-readable rationale and key contributing data sources", "actor": "Mission Operator", "message": "RequestExplanation(COA)", "target_actor": "AIC2 System", "response": "COADetails(COA)"}]	TR2-AIC2-UC-001	DRAFT	2025-12-07 15:22:37.200959	2025-12-15 14:01:59.728592	a1573933-ec35-4bbd-a94c-e0fedbd2581d	[{"trigger": "Model confidence < 70%", "handling": "Flag as low-confidence, route to human analyst for validation", "steps": [{"step_num": 1, "actor": "AIC2 System", "description": "Flag prediction as low-confidence", "message": "FlagPrediction(predictionId, confidence)", "target_actor": "Intel Analyst", "response": "Flagged"}]}]
\.
...
--
-- Name: people uq_person_name_project; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.people
    ADD CONSTRAINT uq_person_name_project UNIQUE (name, project_id);
